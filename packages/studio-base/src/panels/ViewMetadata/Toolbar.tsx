...
import { Constants, ViewMetadataPanelConfig } from "./types";

type Props = {
  canExpandAll: boolean;
  diffEnabled: boolean;
  diffMethod: ViewMetadataPanelConfig["diffMethod"];
        ...
        <div className={classes.diffOptions}>
          <Select
            ...
            onChange={(event: SelectChangeEvent) => {
              saveConfig({
                diffMethod: event.target.value as ViewMetadataPanelConfig["diffMethod"],
              });
            }}
          >
