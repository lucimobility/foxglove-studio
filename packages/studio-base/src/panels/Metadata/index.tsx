...
function WriteMetadata(props: Props) {
  ...
  const onAddMetadataClicked = useCallbackWithToast(() => {
    ...
    setMessage("Metadata was created, don't forget to save and close the file before closing Foxglove in order to save your changes.");
  ...
  }, [currentTime, metadata, metadataName, setMetadata, writeMetadata]);
