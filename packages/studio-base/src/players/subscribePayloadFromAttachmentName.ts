...
import { SubscriptionPreloadType, SubscribeAttachmentPayload } from "./types";
 ...
 */
export function subscribePayloadFromAttachmentName(
  path: string,
  preloadType?: SubscriptionPreloadType,
): undefined | SubscribeAttachmentPayload {
