...
import { McapWriter } from "@mcap/core/dist/esm/src/McapWriter";

import Logger from "@foxglove/log";
import { toNanoSec } from "@foxglove/rostime";
import { Attachment, Metadata } from "@foxglove/studio";
import { Initalization, SourceWriter } from "@foxglove/studio-base/players/IterablePlayer/Writer";

const log = Logger.getLogger(__filename);

export class McapIndexedSourceWriter implements SourceWriter {
  #writer: McapWriter;
  // #start?: Time;
  // #end?: Time;

  public constructor(writer: McapWriter) {
    this.#writer = writer;
  }
  public async initialize(): Promise<Initalization> {
    throw new Error("Method not implemented.");
  }
  public terminate?: (() => Promise<void>) | undefined;
