...
export const panels = {
  ...
  attachmentDescription: "Add attachments to existing Mcap files.",
  ...
  metadataDescription: "Add metadata to existing Mcap files.",
  ...
  viewAttachmentsDescriptions: "View Attachments",
  viewMetadata: "View Metadata",
  viewMetadataDescription: "View Metadata",
};
